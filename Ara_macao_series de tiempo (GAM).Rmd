...
ruta_xlsx <- "~/Library/Mobile Documents/com~apple~CloudDocs/CCGS/Manuscritos/Guacamayas_Lacandona/Ara_macao/Bases_datos/BASE COMPLETA JUL2023_EMM.xlsx"
...
p_partial_manual <- ggplot(grid_pollos, aes(x = n_pollos, y = mu)) +
  ...
  labs(
    ...
    subtitle = "GAM NegBin sin lluvia, IC 95%",
...
ggsave("figs/03b_pollos_sin_lluvia_parcial_manual.png", p_partial_manual, width = 7, height = 5, dpi = 300)
...
p0 <- ggplot(grid_pollos0, aes(x = n_pollos, y = fit)) +
  ...
  geom_vline(xintercept = umbral_est, color = "red", linetype = "dashed") +
  geom_vline(xintercept = umbral_conservador, color = "darkred", linetype = "dotted") +
  labs(
    x = "Pollos rescatados (año actual)",
    y = "Efecto parcial (log-link)",
    title = "Efecto parcial: n_pollos (año actual, escala log)",
...
p1 <- ggplot(grid_pollos1, aes(x = n_pollos_lag1, y = fit)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "black") +
  geom_vline(xintercept = umbral_est_1, color = "red", linetype = "dashed") +
  geom_vline(xintercept = umbral_conf_1, color = "darkred", linetype = "dotted") +
  labs(
    x = "Pollos rescatados (año anterior)",
    y = "Efecto parcial (log-link)",
    title = "Efecto parcial: n_pollos_lag1 (año anterior, escala log)",
